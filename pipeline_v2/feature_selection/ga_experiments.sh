...
./ga_fs_setpack.py --lang pt --metric sc --selec bin --db all --save_log --ngen 300 --pop 50 --mincxpb 0.8 --elsize 0.5 --mutpb 0.02 --divfac 0.5 --verbose --corr_threshold 0.8 --maxs 3 output_ga/all/ga_setpack_cosine_max3_08.csv
